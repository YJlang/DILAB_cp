% pygeek2026-en-camera.tex
% PyGeek 2026 CAMERA-READY 판 — 저자 정보 포함.
% 심사(review) 제출본은 double-blind이므로 저자 정보가 없는 pygeek2026-en.tex 를 쓸 것.
...
\twocolumn[
  ...
  \vspace{9pt}
  \begin{center}
    {\bfseries\fontsize{8}{9.6}\selectfont Junha Yoon\textsuperscript{1}, Ohhyeon Gwon\textsuperscript{2}, Junhaeng Lee\textsuperscript{3}, Hyeji Roh\textsuperscript{3}, Soowan Cho\textsuperscript{4}, Suhee Kim\textsuperscript{4}, and SangSoon Lim\textsuperscript{5}}\par
  \end{center}
  \vspace{6pt}
  {\fontsize{10}{12}\selectfont \textsuperscript{1}BS Course, Department of Media Software, Sungkyul University, South Korea}\par
  \vspace{2pt}
  {\fontsize{10}{12}\selectfont \textsuperscript{2}BS Course, Department of Computer Engineering, Sungkyul University, South Korea}\par
  \vspace{2pt}
  {\fontsize{10}{12}\selectfont \textsuperscript{3}MS Course, College of Art \& Technology, Chung-Ang University, South Korea}\par
  \vspace{2pt}
  {\fontsize{10}{12}\selectfont \textsuperscript{4}Deep Insight Lab, South Korea}\par
  \vspace{2pt}
  {\fontsize{10}{12}\selectfont \textsuperscript{5}Professor, College of Art \& Technology, Chung-Ang University, South Korea}\par
  \vspace{4pt}
  {\fontsize{10}{12}\selectfont Corresponding author: SangSoon Lim (\url{slim@cau.ac.kr})}\par
  \vspace{7pt}
  ...
  \par}
  \vspace{4pt}
  {\bfseries\fontsize{12}{14}\selectfont Keywords: }{\fontsize{8}{9.6}\selectfont Retrieval-Augmented Generation, Vector Database, In-Database Embedding, Migration, Factor Decomposition}\par
  \vspace{4pt}
  \noindent\rule{\linewidth}{0.6pt}\par
  \vspace{6pt}
]
...
\vspace{4pt}
{\fontsize{6.9}{8.1}\selectfont A$\rightarrow$B changes only the store factor, and B$\rightarrow$C only the placement factor. Oracle 26ai denotes Oracle AI Database 26ai [3], and e5-small denotes multilingual-e5-small [4].}
\end{table}
...
% ======================================================================
% Conflict of Interest (required by the template; restored for submission)
% ======================================================================
\pgspecial{Conflict of Interest}
